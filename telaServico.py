...
def abrir_consultaServico():
    subprocess.run(["python", "telaConsultaServico.py"])
...
btn_consultar = Button(tela, text="Consultar", image= foto_consultar, compound= TOP, bg="#F0E68C", command=abrir_consultaServico).place(x=270, y=410)
