...
btn_salvar = Button(tela, text="Salvar", image= foto_salvar, compound= TOP, bg="#f9e6b3").place(x=130, y=410)
btn_excluir = Button(tela, text="Excluir", image= foto_excluir, compound= TOP, bg="#f9e6b3").place(x=200, y=410)
btn_alterar = Button(tela, text="Alterar", image= foto_alterar, compound= TOP, bg="#f9e6b3").place(x=270, y=410)
btn_consultar = Button(tela, text="Consultar", image= foto_consultar, compound= TOP, bg="#f9e6b3").place(x=340, y=410)
btn_sair = Button(tela, text="Sair", image= foto_sair, compound= RIGHT, bg="#f9e6b3").place(x=620, y=440)
